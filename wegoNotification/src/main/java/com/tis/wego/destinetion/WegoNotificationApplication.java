...
public class WegoNotificationApplication {

	private static Logger _logger = Logger.getLogger(WegoNotificationApplication.class.getName());
	public static void main(String[] args) {
	_logger.info("::::   WegoNotificationApplication ::::  This module deals with Destinetion and mapping end points ");
	SpringApplication.run(WegoNotificationApplication.class, args);
	}
